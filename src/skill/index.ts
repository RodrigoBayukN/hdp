...
export namespace Skill {
  ...
  const HDP_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.HDP_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, HDP_SKILL_PATTERN)
    }
  ...
  export class Service extends Context.Service<Service, Interface>()("@hdp/Skill") {}
