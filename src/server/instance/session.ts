  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all HDP sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific HDP session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new HDP session for interacting with AI assistants and managing conversations.",
